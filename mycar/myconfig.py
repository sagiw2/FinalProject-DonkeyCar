...
# 
# #STEERING
STEERING_CHANNEL = 15            #channel on the 9685 pwm board 0-15
...
# 
# #THROTTLE
THROTTLE_CHANNEL = 14            #channel on the 9685 pwm board 0-15
...
# SIM_ARTIFICIAL_LATENCY = 300          # this is the millisecond latency in controls. Can use useful in emulating the delay when useing a remote server. values of 100 to 400 probably reasonable.
# 
